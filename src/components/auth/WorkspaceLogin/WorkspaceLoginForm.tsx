...
export const WorkspaceLoginForm = () => {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    if (values.email === 'zlancers9898@gmail.com') {
  ...
  return (
    <div className='bg-white w-3/4 md:w-2/4 '>
      ...
      <p className='text-gray-600 mb-6'>
        ...
        Login with your email to access your dashboard and manage your
        courses.
      </p>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                {isInvalidWorkspaceId && (
                  <div className='py-2'>
                    <Alert variant="destructive">
                      <AlertCircleIcon />
                      <AlertTitle>Please try again</AlertTitle>
                      <AlertDescription>
                        <p>The Email or Password that you entered does not exist </p>
                      </AlertDescription>
                    </Alert>
                  </div>
                )}
...
export default WorkspaceLoginForm
