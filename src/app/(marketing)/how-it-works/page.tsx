export default function HowItWorks() {
  return (
    <div className='py-8'>
      <h1 className='text-2xl text-center py-20'> How it works</h1>
      <h1 className='text-2xl font-bold pt-4 px-10 text-gray-800'>
      ...
      <p className='text-gray-600 mt-2 px-10'>
        Power-up your own branded learning community with ease. Create, manage,
        and sell courses, with smart AI suggestions.
      </p>
      <ul>
        <li>
          <p className='text-gray-600 mt-2 px-10'>
          ...
          <ul>
            ...
            <li>
              <p className='text-gray-600 mt-2 px-10'>
                - <strong>Custom Branding</strong>: Fully customize your LMS to
